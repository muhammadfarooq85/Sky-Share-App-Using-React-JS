...
const resources = {
  en: {
    translation: {
      ...
      noteSettings: "Note:- Be serious while filling these fields.",
      ...
      pleaseLogin: "Please Login first to manage your account.",
  ...
  ur: {
    translation: {
      ...
      noteSettings: `نوٹ:- ان شعبوں کو بھرتے وقت سنجیدہ رہیں۔`,
      prevEmail: "پچھلا ای میل",
      newEmail: "نیا ای میل",
      newPassword: "نیا پاس ورڈ",
      updateEmail: "اپ ڈیٹ ای میل",
      updatePassword: "اپ ڈیٹ پاس ورڈ",
      signout: "باہر جائیں",
      ...
      pleaseLogin: "اپنے اکاؤنٹ کا نظم کرنے کے لیے براہ کرم پہلے لاگ ان کریں۔",
